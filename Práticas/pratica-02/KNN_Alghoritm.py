...
"""
    Resample(60 samples)
"""
X_train3, y_train3 = resample(X_train,y_train, n_samples=60)
knn3 = KNeighborsClassifier(n_neighbors=1)
knn3.fit(X_train3, y_train3)
pred_knn3 = knn.predict(X_test)
confusion3= confusion_matrix(y_test, pred_knn3)
...
"""
    Resample(40 samples)
"""
X_train3, y_train3 = resample(X_train,y_train, n_samples=40)
knn3 = KNeighborsClassifier(n_neighbors=1)
knn3.fit(X_train3, y_train3)
pred_knn3 = knn.predict(X_test)
confusion3= confusion_matrix(y_test, pred_knn3)
...
"""
    Resample(20 samples)
"""
X_train3, y_train3 = resample(X_train,y_train, n_samples=20)
knn3 = KNeighborsClassifier(n_neighbors=1)
knn3.fit(X_train3, y_train3)
pred_knn3 = knn.predict(X_test)
confusion3= confusion_matrix(y_test, pred_knn3)
